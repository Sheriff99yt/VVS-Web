...
> = {
  ...
  cpp: [
    ...
    'DestructorOpen',
    'DestructorOutOfLineOpen',
    'ConstructorOutOfLineOpen',
    'ConstructorDeclPrototype',
    'DestructorDeclPrototype',
  ],
...
const PACK_FAMILIES = ['python', 'cpp', 'javascript', 'verse', 'gdscript', 'rust', 'csharp', 'go'] as const;
