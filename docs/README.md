...
| Document | Content |
|----------|---------|
| [vvs_2_0_tech_stack.md](vvs_2_0_tech_stack.md) | Locked technology choices and resolved stack debates |
...
## Historical / frozen (do not treat as product setup)
...
| [design/language_capability_catalog.md](design/language_capability_catalog.md) | Capability catalog |
| [design/multi_class_symbols.md](design/multi_class_symbols.md) | Multi-class symbols |
| [design/unified_symbol_model.md](design/unified_symbol_model.md) | Unified symbols / future COA |
| [design/user_types.md](design/user_types.md) | User types |
| [design/class_scopes_and_symbols.md](design/class_scopes_and_symbols.md) | Class scopes |
| [design/terms_refactor_plan.md](design/terms_refactor_plan.md) | Vocabulary rollout plan |
