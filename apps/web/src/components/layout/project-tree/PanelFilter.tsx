...
export function PanelFilter({
  ...
  return (
    <div
      className="flex items-center gap-1.5 flex-1 min-w-0 h-7 px-2 rounded border border-zinc-800 bg-zinc-900/80 focus-within:border-zinc-600"
      title={`${placeholder} (${shortcutKeys('panel-filter')} or /)`}
    >
