...
export function GraphSettingsModal() {
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-start justify-center pt-[12vh] bg-black/50">
      <div
        className="w-[min(400px,calc(100%-24px))] max-h-[70vh] flex flex-col bg-zinc-950 border border-zinc-800 rounded-lg shadow-xl overflow-hidden"
        role="dialog"
